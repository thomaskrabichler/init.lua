...
keyset("n", "<leader>fl", ":belowright split | only | CocCommand flutter.dev.openDevLog<CR>", opts)
--keyset("n", "<leader>fl", ":CocCommand flutter.dev.openDevLog<CR> | :rightbelow split | resize 20%" , opts)
--keyset("n", "<leader>fl", ":belowright split | CocCommand flutter.dev.openDevLog<CR>", opts)
...
--keyset("n", "<leader>ff",  "<cmd>call CocAction('format')<CR>", opts)
