...
_G.packer_plugins = {
  ...
  ["goyo.vim"] = {
    loaded = true,
    path = "/home/tom/.local/share/nvim/site/pack/packer/start/goyo.vim",
  ...
  ["oxocarbon.nvim"] = {
    loaded = true,
    path = "/home/tom/.local/share/nvim/site/pack/packer/start/oxocarbon.nvim",
  ...
  ripgrep = {
    loaded = true,
    path = "/home/tom/.local/share/nvim/site/pack/packer/start/ripgrep",
